...
cartsRouter.get('/:cid',onlyLoggedin, async (req, res) => {
       try {
...
// @ts-ignore
cartsRouter.get('/',onlyLoggedin, onlyAdmin, async (req, res) => {
const carritos = await carritosRepository.buscarCarritos()
const arrayCarritos = []
// @ts-ignore
...
cartsRouter.post('/:cid/product/:pid',onlyLoggedin, async (req, res) => {
    try {
...
cartsRouter.put('/:cid/product/:pid',onlyLoggedin, async (req, res) => {
    try {
        const cid = req.params.cid
        const pid = req.params.pid
...
cartsRouter.get('/:cid/productoEliminar/:pid',onlyLoggedin,async(req,res)=>{
...
cartsRouter.get('/:cid/vaciarCarrito',onlyLoggedin,async(req,res)=>{
...
cartsRouter.delete('/:cid',onlyLoggedin,async( req,res)=>{
...
cartsRouter.delete('/:cid/products/:pid',onlyLoggedin,async( req,res)=>{
...
cartsRouter.get('/:cid/purchase',onlyLoggedin, async(req,res)=>{
    //datos Usuario
